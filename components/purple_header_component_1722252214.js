...
Vue.component("purple_header_component_1722252214", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Blockchain Insights-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Blockchain Insights.html" :class="[textStylePrimary, hoverTextStylePrimary]">Blockchain Insights</a></li>
                        <li><a id="Developers-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Developers.html" :class="[textStylePrimary, hoverTextStylePrimary]">Developers</a></li>
                ...
                <ul id="desktop-sign-in-links" class="flex-1 flex justify-end items-center">
                    ...
                    <li class="ml-6"><button id="hello-world-button" class="btn-sm transition duration-150 ease-in-out" :class="[signUpButtonText, signUpButtonHover, signUpButtonGradient]">Hello World</button></li>
                </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Blockchain Insights-link" class="flex font-medium text-sm py-1.5" href="Blockchain Insights.html" :class="[textStylePrimary,hoverTextStylePrimary]">Blockchain Insights</a></li>
                            <li><a id="mobile-Developers-link" class="flex font-medium text-sm py-1.5" href="Developers.html" :class="[textStylePrimary,hoverTextStylePrimary]">Developers</a></li>
